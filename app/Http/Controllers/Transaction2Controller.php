...
class Transaction2Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('transactions2.index', compact('transactions', 'members', 'statistics'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $transaction = Transaction2::findOrFail($id);
    ...
    public function export(Request $request)
    {
        try {
            ...
            foreach ($transactions as $transaction) {
                ...
                $sheet->setCellValueExplicit('B' . $row, $formattedDate, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
            ...
            // 파일명 생성
            $filename = '현금영수증_대전_' . now()->format('Y-m-d') . '.xls';
