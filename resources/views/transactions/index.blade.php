        ...
        <form action="{{ route('transactions.index') }}" method="GET" class="row g-3">
            ...
            <div class="col-12 mt-3">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('transactions.index') }}" class="btn btn-secondary">초기화</a>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" class="account-form">
                            @csrf
                            @method('PUT')
                            <select name="account" 
                    ...
                    <td>
                        <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" class="manager-form">
                            @csrf
                            @method('PUT')
                            <select name="manager" 
                    ...
                    <td>
                        <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" class="memo-form">
                            @csrf
                            @method('PUT')
