...
<div class="container-fluid px-4">
    ...
    <div class="filters-container mb-4">
        <form action="{{ route('transactions2.index') }}" method="GET" class="row g-3">
            ...
            <div class="col-lg-2 col-md-6">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="exclude_refunds">
                        송달환급금 등 불포함
                    </label>
                </div>
            </div>
            ...
            <div class="col-12 mt-3">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('transactions2.index') }}" class="btn btn-secondary">초기화</a>
                    <a href="{{ route('transactions2.export') }}?{{ http_build_query(request()->all()) }}" 
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('transactions2.update', $transaction->id) }}" method="POST" class="account-form">
                            @csrf
                            @method('PUT')
                            <select name="account" 
                    ...
                    <td>
                        <form action="{{ route('transactions2.update', $transaction->id) }}" method="POST" class="manager-form">
                            @csrf
                            @method('PUT')
                            <select name="manager" 
                    ...
                    <td>
                        <form action="{{ route('transactions2.update', $transaction->id) }}" method="POST" class="memo-form">
                            @csrf
                            @method('PUT')
