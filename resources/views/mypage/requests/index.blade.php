        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">나의 신청함</h5>
                    <a href="{{ route('mypage.requests.create') }}" class="btn btn-primary btn-sm">신청서 작성</a>
                </div>
                <div class="card-body">
                    @if(count($requests) > 0)
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach($requests as $request)
                                        <tr class="clickable-row" data-href="{{ route('mypage.requests.show', $request->id) }}" style="cursor: pointer;">
                    ...
                    @else
                        <div class="text-center py-4">
                            <p class="text-muted">신청 내역이 없습니다.</p>
                            <a href="{{ route('mypage.requests.create') }}" class="btn btn-primary">신청서 작성하기</a>
                        </div>
                    @endif
                </div>
            </div>
