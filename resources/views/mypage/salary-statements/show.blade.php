            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('mypage.salary-statements.pdf', $salaryStatement) }}" 
                           class="btn btn-outline-danger">
                            <i class="fas fa-file-pdf"></i> PDF 다운로드
                        </a>
                        @if(!$salaryStatement->approved_at)
                            <form action="{{ route('mypage.salary-statements.approve', $salaryStatement) }}" 
                                  method="POST" 
                                  style="display: inline;"
                                  onsubmit="return confirm('급여명세서를 승인하시겠습니까?');">
                                @csrf
                        ...
                        @endif
                        <a href="{{ route('mypage.salary-statements.index') }}" 
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>이름</label>
                                        <input type="text" class="form-control bg-light" value="{{ $salaryStatement->user->name }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>직급</label>
                                        <input type="text" class="form-control bg-light" value="{{ $salaryStatement->user->member->position }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>업무</label>
                                        <input type="text" class="form-control bg-light" value="{{ $salaryStatement->user->member->task }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>지역</label>
                                        <input type="text" class="form-control bg-light" value="{{ $salaryStatement->user->member->affiliation }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
